...
public class DBConstants {
    ...
    public static final String GET_USER = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME from ticket t where t.VEHICLE_REG_NUMBER=? AND t.PRICE > 0 limit 1";
}
